...
<!--                                <small class="label pull-right bg-red">3</small>-->
                        ...
                        <li><a href="index2.php?mod=buku&pg=buku_list"><i class="fa fa-book"></i><span>PENGELOLAAN BUKU</span>
                            <i class="fa fa-angle-left pull-right"></i>
                            <ul class="treeview-menu">
                                <li><a href="index2.php?mod=buku&pg=buku_list"><i class="fa fa-plus"></i>PENGADAAN BUKU</a></li>
                                <li><a href="index2.php?mod=supplier&pg=supplier_list"><i class="fa fa-user-plus"></i>PENGELOLAAN SUPPLIER</a></li>
                                
                            </ul>
                            </a></li>
						<li><a href="index2.php?mod=anggota&pg=anggota_list"><i class="fa fa-user"></i><span>PENGELOLAAN ANGGOTA</span></a></li>
                        <li><a href="index2.php?mod=peminjaman&pg=peminjaman_list"><i class="fa fa-balance-scale"></i><span>PENGELOLAAN PEMINJAMAN</span></a></li>
                        <li><a href="index2.php?mod=pelaporan&pg=pelaporan"><i class="fa fa-file-o"></i><span>PELAPORAN</span></a></li>
...
//}
//else{
//    exit(header("Location: index1.php"));
//}
//        
//        
//    }
