            ...
            <aside class="main-sidebar">
                ...
                <section class="sidebar">
                    ...
                    <ul class="sidebar-menu">
                        ...
                        <li>
                            <a href="<?php echo getBaseUrl() ?>dashboard.php">
                                <i class="fa fa-laptop"></i> <span>DASHBOARD</span>
<!--                                <small class="label pull-right bg-red">3</small>-->
                            </a>
                        </li>
                        <li><a href="index2.php?mod=buku&pg=buku_list"><i class="fa fa-book"></i><span>PENGELOLAAN BUKU</span></a></li>
						<li><a href="index2.php?mod=anggota&pg=anggota_list"><i class="fa fa-book"></i><span>PENGELOLAAN ANGGOTA</span></a></li>
                        <li><a href="index2.php?mod=peminjaman&pg=peminjaman_list"><i class="fa fa-book"></i><span>PENGELOLAAN PEMINJAMAN</span></a></li>
                        <li><a href="index2.php?mod=pelaporan&pg=pelaporan"><i class="fa fa-book"></i><span>PELAPORAN</span></a></li>
