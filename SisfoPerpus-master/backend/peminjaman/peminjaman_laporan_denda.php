            ...
            <div class='col-xs-12'>
              <div class='box'>
                <div class='box-header'>
                  <h3 class='box-title'>Laporan Pemasukan Denda </h3>
...
<option value="index2.php?mod=peminjaman&pg=peminjaman_laporan_denda">Pemasukan Denda</option>
		...
		<a href="peminjaman/peminjaman_denda_doc.php" class="btn btn-primary btn-sm"><i class="fa fa-file-word-o"></i> Print</a>
