...
<html>
    <head>
        ...
        <!-- iCheck -->
        <link rel="stylesheet" href="../../system/plugins/iCheck/square/blue.css">
    ...
    <body class="hold-transition login-page">
        <div class="login-box">
            ...
            <div class="login-box-body">
                <p class="login-box-msg">incorrect login</p>
                <form action="login/login_action.php" method="post">
                <div class="form-group has-feedback">
                    
                    <tr>
            <td><input type="text" class="form-control" name="username" id="username" placeholder="Username" required / >
        </td>
            ...
            <td><input type="password" class="form-control" name="password" id="password" placeholder="Password" required />
                ...
                <div align="right" class="form-group has-feedback">
                    <a href="" onclick="return confirm('Hubungi Administrator \nNo. Telepon 085624837528 \nEmail : ilhamhanif1512@yahoo.com ')">Lupa Password? </a>
                </div>
                <div class="row">
